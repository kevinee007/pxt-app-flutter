...
import 'package:projectx/NodeRewardsMannager.g.dart';
import 'package:projectx/utils/web3/config.dart';
import 'package:web3dart/web3dart.dart';

class NodeDataFeed {
  late String _rpcUrl;
  late NodeRewardsMannager _nodeRewardsManagerInstance;
  ...
  NodeDataFeed({String strRpcUrl = Web3Config.defRPCUrl, String strNodeRewardsContractAddress = Web3Config.defNodeRewardsContractAddress}) {
    ...
    _nodeRewardsManagerInstance = NodeRewardsMannager(address: EthereumAddress.fromHex(strNodeRewardsContractAddress), client: web3client);
  }
