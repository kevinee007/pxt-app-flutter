...
class NodeRewardsMannagerTest extends _i1.GeneratedContract {
  ...
  /// like the gas price, nonce and max gas. The `data` and `to` fields will be
  /// set by the contract.
  Future<String> changeGasDistri(BigInt newGasDistri,
      {required _i1.Credentials credentials,
      _i1.Transaction? transaction}) async {
  ...
  /// set, the function will be evaluated in the specified block. By default, the
  /// latest on-chain block will be used.
  Future<String> _getNodesLastClaimTime(_i1.EthereumAddress account,
      {_i1.BlockNum? atBlock}) async {
  ...
  /// set, the function will be evaluated in the specified block. By default, the
  /// latest on-chain block will be used.
  Future<String> _getNodesRewardAvailable(_i1.EthereumAddress account,
      {_i1.BlockNum? atBlock}) async {
  ...
  /// set, the function will be evaluated in the specified block. By default, the
  /// latest on-chain block will be used.
  Future<BigInt> _getRewardAmountOf(_i1.EthereumAddress account,
      {_i1.BlockNum? atBlock}) async {
  ...
  /// set, the function will be evaluated in the specified block. By default, the
  /// latest on-chain block will be used.
  Future<bool> _isNodeOwner(_i1.EthereumAddress account,
      {_i1.BlockNum? atBlock}) async {
  ...
  /// like the gas price, nonce and max gas. The `data` and `to` fields will be
  /// set by the contract.
  Future<String> refreshNodeRewards(BigInt gas,
      {required _i1.Credentials credentials,
      _i1.Transaction? transaction}) async {
    final function = self.abi.functions[32];
    assert(checkSignature(function, '5630f5f3'));
    final params = [gas];
    return write(credentials, transaction, function, params);
  }
